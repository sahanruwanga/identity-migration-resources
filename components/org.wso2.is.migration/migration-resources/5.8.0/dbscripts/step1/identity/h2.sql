...
ALTER TABLE IDN_OAUTH2_AUTHORIZATION_CODE ADD COLUMN IF NOT EXISTS IDP_ID INTEGER NOT NULL DEFAULT -1;

ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN ADD COLUMN IF NOT EXISTS IDP_ID INTEGER NOT NULL DEFAULT -1;

ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN_AUDIT ADD COLUMN IF NOT EXISTS IDP_ID INTEGER NOT NULL DEFAULT -1;
