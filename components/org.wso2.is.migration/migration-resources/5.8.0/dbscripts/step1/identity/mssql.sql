...
IF NOT EXISTS (SELECT * FROM SYS.COLUMNS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_OAUTH2_AUTHORIZATION_CODE]') AND name = 'IDP_ID') BEGIN ALTER TABLE IDN_OAUTH2_AUTHORIZATION_CODE ADD IDP_ID INTEGER NOT NULL CONSTRAINT IDP_ID_DEFAULT DEFAULT (-1); END IF NOT EXISTS (SELECT * FROM SYS.COLUMNS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_OAUTH2_ACCESS_TOKEN]') AND name = 'IDP_ID') BEGIN ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN ADD IDP_ID INTEGER NOT NULL CONSTRAINT IDP_ID_DEFAULT DEFAULT (-1); END IF NOT EXISTS (SELECT * FROM SYS.COLUMNS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_OAUTH2_ACCESS_TOKEN_AUDIT]') AND name = 'IDP_ID') BEGIN ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN_AUDIT ADD IDP_ID INTEGER NOT NULL CONSTRAINT IDP_ID_DEFAULT DEFAULT (-1); END
